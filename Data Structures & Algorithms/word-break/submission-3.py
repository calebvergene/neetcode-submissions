class Solution:
    def wordBreak(self, s: str, wordDict: List[str]) -> bool:
        ...
        # will be 2 : [6, 8] meaning that 2 to 6 form a word or 2 to 8 form a word
        memoiz = collections.defaultdict(list)
        ...
        def dp(start):
            ...
            # word with starting index already parsed and stored
            if start in memoiz:
                for i in memoiz[start]:
                    if dp(i):
                        return True
